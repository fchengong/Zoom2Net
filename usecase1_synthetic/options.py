...
class Options(object):
    ...
    def __init__(self):
        ...
        # Data preparation
        self.parser.add_argument('--window_size', type=int, default=300,
        ...
        self.parser.add_argument('--d_model', type=int, default=80,
        ...
        self.parser.add_argument('--dim_feedforward', type=int, default=40,
