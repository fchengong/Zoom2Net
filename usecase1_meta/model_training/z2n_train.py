...
def train_z2n(config, train_dataset_processed, test_dataset_processed, seed):
    ...
    # Data refinement
    train_dataset_refined = data_refinement(train_dataset_processed, config)
    ...
    max_len = 4*int(WINDOW_SIZE / COARSE)
    ...
    while True:
        ...
        epoch = 0
        train_early_stopper = utils.EarlyStopper(patience=5, min_delta=0.0001)
        ...
        check_constr, sum_constr, retrans_constr, \
